...
public class AlbumResultActivity extends AppCompatActivity {
    String pred;
    ...
    private void initView() {
        result_text = findViewById(R.id.album_result_text);
        return_Btn = findViewById(R.id.album_result__return_btn);
        album_imageView = findViewById(R.id.albumimageview);
        introduce_text=findViewById(R.id.album_introduce_text);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        album_imageView.setImageBitmap(bitmap);//将图片放置在控件上
        return_Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlbumResultActivity.this.finish();
            }
        });
    }
}
